...
<head>
    ...
    <title>Mahindra Thar - Car Details</title>
        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="car-gallery">
                    <img src="perimg/thar2.avif" alt="Mahindra Thar" class="img-fluid">
                </div>
            </div>
            <div class="col-lg-5">
                <div class="car-info">
                    <h1 class="car-title">Mahindra Thar</h1>
                    <div class="price-tag">₹6,000 / day</div>
                    
                    <ul class="feature-list">
                        <li class="feature-item">
                            <i class="fas fa-car"></i>
                            <span>4 Seater SUV</span>
                        </li>
                        <li class="feature-item">
                            <i class="fas fa-gas-pump"></i>
                            <span>Diesel - 15.2 kmpl</span>
                        </li>
                        <li class="feature-item">
