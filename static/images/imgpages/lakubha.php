...
<head>
    ...
    <title>Lakubha Hall - Premium Event Venue</title>
    <style>
        :root {
            --primary: #2c3e50;
            --secondary: #e74c3c;
...
<body>
    <div class="venue-container">
        <div class="image-gallery">
            <img src="perimg/lakhubha.jpg" alt="Lakubha Hall">
            <span class="venue-status">Premium Venue</span>
        </div>
        
        <div class="details-section">
            <h1 class="venue-title">Lakubha Hall</h1>
            <div class="price-display">
                <i class="fas fa-tag"></i>
                ₹10,000 <span style="font-size: 1rem; color: var(--dark);">/per day</span>
            </div>
