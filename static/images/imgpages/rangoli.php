...
<head>
    ...
    <title>Rangoli Hall - Premium Event Venue</title>
    <style>
        :root {
            --primary: #2c3e50;
            --secondary: #e74c3c;
...
<body>
    <div class="venue-container">
        <div class="image-gallery">
            <img src="perimg/rangoli2.jpg" alt="Rangoli Hall">
            <span class="venue-status">Premium Venue</span>
        </div>
        
        <div class="details-section">
            <h1 class="venue-title">Rangoli Hall</h1>
            ...
            <div class="features-grid">
                ...
                <div class="feature-item">
                    ...
                    <div class="feature-details">
                        <h4>Address</h4>
                        <p>123 Celebration Street, City</p>
                    </div>
                </div>
            </div>
