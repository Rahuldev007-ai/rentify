...
<head>
    ...
    <title>Shiv Sakti Hall - Premium Event Venue</title>
    <style>
        :root {
            --primary: #2c3e50;
            --secondary: #e74c3c;
...
<body>
    <div class="venue-container">
        <div class="image-gallery">
            <img src="perimg/shivsakti.jpg" alt="Shiv Sakti Hall">
            <span class="venue-status">Premium Venue</span>
        </div>
        
        <div class="details-section">
            <h1 class="venue-title">Shiv Sakti Hall</h1>
            <div class="price-display">
                <i class="fas fa-tag"></i>
                ₹12,000 <span style="font-size: 1rem; color: var(--dark);">/per day</span>
            </div>
