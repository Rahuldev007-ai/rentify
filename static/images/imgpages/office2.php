    ...
    <div class="main-container">
        <div class="office-card">
            <div class="image-gallery">
                <img src="perimg/o2.jpg" alt="Premium Office Space" class="main-image">
            </div>
            
            <div class="office-details">
                <h1 class="office-title">Executive Office Suite</h1>
                <div class="price-tag">₹40,000/month</div>
                
                <div class="feature-list">
                    <div class="feature-item">
                        <i class="fas fa-ruler-combined"></i>
                        <span>1500 sq.ft Area</span>
                    </div>
                    <div class="feature-item">
                ...
                <div class="location-info">
                    ...
                    <p>Strategic location in Bhavnagar's business district, with easy access to major transportation hubs and business centers.</p>
                </div>
