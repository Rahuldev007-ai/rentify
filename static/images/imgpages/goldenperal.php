...
<head>
    ...
    <title>Golden Pearl Hall - Premium Event Venue</title>
    <style>
        :root {
            --primary: #2c3e50;
            --secondary: #e74c3c;
...
<body>
    <div class="venue-container">
        <div class="image-gallery">
            <img src="perimg/goldenpearl.jpg" alt="Golden Pearl Hall">
            <span class="venue-status">Premium Venue</span>
        </div>
        
        <div class="details-section">
            <h1 class="venue-title">Golden Pearl Hall</h1>
            <div class="price-display">
                <i class="fas fa-tag"></i>
                ₹18,000 <span style="font-size: 1rem; color: var(--dark);">/per day</span>
            </div>
