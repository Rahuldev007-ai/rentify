...
<head>
    ...
    <title>Maruti Swift - Car Details</title>
        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="car-gallery">
                    <img src="perimg/c11.jpg" alt="Maruti Swift" class="img-fluid">
                </div>
            </div>
            <div class="col-lg-5">
                <div class="car-info">
                    <h1 class="car-title">Maruti Swift</h1>
                    <div class="price-tag">₹3,000 / day</div>
                    
                    <ul class="feature-list">
                        <li class="feature-item">
                            <i class="fas fa-car"></i>
                            <span>5 Seater Hatchback</span>
                        </li>
                        <li class="feature-item">
                            <i class="fas fa-gas-pump"></i>
                            <span>Petrol - 23.2 kmpl</span>
                        </li>
                        <li class="feature-item">
                        ...
                        <li class="feature-item">
                            ...
                            <span>SmartPlay Infotainment</span>
                        </li>
                        <li class="feature-item">
                            <i class="fas fa-shield-alt"></i>
                            <span>Dual Airbags & ABS</span>
                        </li>
                    </ul>
