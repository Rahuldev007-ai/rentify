    ...
    <div class="bike-container">
        <div class="bike-card">
            <div class="image-gallery">
                <img src="perimg/bullet.jpg" alt="Royal Enfield Bullet">
                <span class="bike-status">Premium Bike</span>
            </div>
            
            <div class="specs-section">
                <h1 class="bike-title">Royal Enfield Bullet 350</h1>
                <div class="price-display">
                    <i class="fas fa-tag"></i>
                    ₹2,500 <span style="font-size: 1rem; color: var(--dark);">/per day</span>
                </div>
