...
<head>
    ...
    <title>Toyota Fortuner - Car Details</title>
        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="car-gallery">
                    <img src="perimg/fortuner.jpg" alt="Toyota Fortuner" class="img-fluid">
                </div>
            </div>
            <div class="col-lg-5">
                <div class="car-info">
                    <h1 class="car-title">Toyota Fortuner</h1>
                    <div class="price-tag">₹10,000 / day</div>
                    
                    <ul class="feature-list">
                        <li class="feature-item">
                            <i class="fas fa-car"></i>
                            <span>7 Seater Premium SUV</span>
                        </li>
                        <li class="feature-item">
                            <i class="fas fa-gas-pump"></i>
                            <span>Diesel - 17.4 kmpl</span>
                        </li>
                        <li class="feature-item">
                        ...
                        <li class="feature-item">
                            ...
                            <span>4x4 Terrain Select</span>
                        </li>
                        <li class="feature-item">
                            <i class="fas fa-tv"></i>
                            <span>8" Touchscreen Display</span>
                        </li>
                        <li class="feature-item">
                            <i class="fas fa-shield-alt"></i>
                            <span>7 Airbags & VSC</span>
                        </li>
                    </ul>
